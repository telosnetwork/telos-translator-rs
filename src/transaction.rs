use alloy::primitives::{Address, B256, Log, Signature, U256};
...
pub fn make_unique_vrs(block_hash_native: Checksum256, sender_address: Address, trx_index: usize) -> Signature {
    let v = 42u64;
...
impl Transaction {
    pub async fn from_raw_action(chain_id: u64, trx_index: usize, block_hash: Checksum256, raw: RawAction, receipt: PrintedReceipt) -> Self {
