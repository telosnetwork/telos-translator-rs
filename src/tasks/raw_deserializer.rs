...
async fn process_ship_msg(
    ...
    let mut unackd_blocks = prev_unacked;
    let mut last_log = prev_last_log;
    let mut unlogged_blocks = prev_unlogged;
    ...
    (unackd_blocks, unlogged_blocks, last_log)
}
...
pub async fn raw_deserializer(
    ...
    let mut must_lock_for_ship = true;
